...
<div id="tabs" class="size-1col padding">
    ...
    <div id="cluster_servers">
        <form method="post" action="configure.php?request_write=servers">
            ...
            <div id="server_form">
            <?php
            # Adding a div foreach clusters
            foreach($_ini->clusters() as $cluster)
            { ?>
                <div id="cluster_<?php echo $cluster; ?>">
                Cluster <?php echo $cluster; ?>
                <?php
                # Adding input for every server
                foreach($_ini->servers($cluster) as $server => $data)
                { ?>
    ...
    <div id="commands">
        <form method="post" action="configure.php?request_write=commands">
            <div class="row">
                <strong>Memcached commands API used by phpMemCacheAdmin</strong>
                <br/>
                <br/>
                <strong>Recommendations :</strong><br/>
            ...
            <div style="margin-left:20px;margin-top:20px;">
                <div>
                    <strong>Stats</strong>
                    <hr/>
                    A text to indicate what is the usage
                    <div class="row">
