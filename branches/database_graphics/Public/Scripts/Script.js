...
function changeGraphic(obj, stats)
{
    if (obj.options[obj.selectedIndex].value != '')
    {
        window.location = 'graphics.php?stats=' + stats + '&server=' + obj.options[obj.selectedIndex].value;
    } else
    {
        window.location = 'graphics.php?stats=' + stats;
    }
}
