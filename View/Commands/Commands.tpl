...
?>
    ...
    <div style="float:left;">
        <span class="title rounded" style="width:372px;">Get Command</span>
        <div class="container rounded" style="width:372px; padding:7px 7px 7px 7px;">
    ...
    <div style="float:left; padding-left:10px;">
        <span class="title rounded" style="width:372px;">Set Command</span>
        <div class="container rounded" style="width:372px; padding:7px 7px 7px 7px;">
