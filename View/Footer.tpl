            <div class="sub-header corner full-size padding" style="float:left; text-align:center; margin-top:18px;">
                <a href="http://code.google.com/p/phpmemcacheadmin/" target="_blank">phpMemCacheAdmin on GoogleCode</a>
                 ...
                 - <a href="http://www.maatkit.org/" target="_blank">Maatkit Profiler</a>
            </div>
        </div>
    </body>
</html>